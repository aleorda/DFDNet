...
class AlignedDataset(BaseDataset):
    ...
    def AddDownSample(self, img):  # downsampling
        ...
        img = img.resize((int(self.opt.fineSize / sampler * 10.0), int(self.opt.fineSize / sampler * 10.0)),
                         Image.BICUBIC)
        return img
    ...
    def __getitem__(self, index):  #
        ...
        C = A
        A = self.add_up_sample(self.AddJPEG(self.AddNoise(self.AddDownSample(self.AddBlur(A)))))
